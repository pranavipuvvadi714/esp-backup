...
int main(int argc, char *argv[])
{
    ...
    int sprint_length = 15; //In multiples of 8192 cycles
    ...
    write_sprint(sprint_tile_1, 1, 4, sprint_length); //SPRINT
    ...
    write_sprint(sprint_tile_2, 1, 4, sprint_length); //SPRINT
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started V0\n");
    #endif
    ...
    write_sprint(sprint_tile_3, 1, 4, sprint_length); //SPRINT
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started F1\n");
    #endif
   ...
   // write_sprint_cfg(router_tile_4, 15, 5, 1);    // duration=15, tokens=5, enable=1 //pranavi
    ...
    write_sprint(sprint_tile_4, 1, 4, sprint_length); //SPRINT
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started V1\n");
    #endif
    ...
    write_sprint(sprint_tile_5, 1, 4, sprint_length); //SPRINT
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started F2\n");
    #endif
...
///////////////////////////////////////////////////////////////////////////////////////////
   ...
   // Start NVDLA normally
    ...
    write_sprint(sprint_tile_0, 1, 4, sprint_length); //SPRINT
